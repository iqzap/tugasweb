      ...
      <div class="container">
        ...
        <div class="col s12 l4 input-field">
        	<div class="card">
        		<div class="container">
        			<br>	
        		  <form method="POST" action="{{route('admin.update')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                      {{ csrf_field() }}
        				...
        				<div class="row" style="display:none">
        						<div class="input-field col s12 l12">
						          <input id="id_barang" name="id_barang" type="text" class="validate" value="{{$id}}">
                        ...
                        <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                  <input class="file-path validate" type="text" placeholder="Upload Gambar">
										   	...
										   	<input type="submit" class="btn waves-effect waves-light btn-large" style="width: 100%;" value="Simpan">
